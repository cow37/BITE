...
CREATE TABLE `iniciativa` (
  `cod_iniciativa` int unsigned NOT NULL AUTO_INCREMENT,
  `nombre_iniciativa` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `estado` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`cod_iniciativa`)
...
INSERT INTO `iniciativa` VALUES (1,'Inciativa Popular','Inactivo'),(2,'Extension Universitaria','Activo');
...
-- Dump completed on 2024-01-22 13:42:51
